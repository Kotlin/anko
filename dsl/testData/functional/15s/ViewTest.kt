...
public fun ViewManager.rSSurfaceView(init: android.renderscript.RSSurfaceView.() -> Unit = defaultInit): android.renderscript.RSSurfaceView =
  addView(android.renderscript.RSSurfaceView(dslContext), init, this)
public fun Context.rSSurfaceView(init: android.renderscript.RSSurfaceView.() -> Unit = defaultInit): android.renderscript.RSSurfaceView =
  addContextTopLevelView(android.renderscript.RSSurfaceView(this), init)
public fun Activity.rSSurfaceView(init: android.renderscript.RSSurfaceView.() -> Unit = defaultInit): android.renderscript.RSSurfaceView =
  addActivityTopLevelView(android.renderscript.RSSurfaceView(this), init)

public fun ViewManager.rSTextureView(init: android.renderscript.RSTextureView.() -> Unit = defaultInit): android.renderscript.RSTextureView =
  addView(android.renderscript.RSTextureView(dslContext), init, this)
public fun Context.rSTextureView(init: android.renderscript.RSTextureView.() -> Unit = defaultInit): android.renderscript.RSTextureView =
  addContextTopLevelView(android.renderscript.RSTextureView(this), init)
public fun Activity.rSTextureView(init: android.renderscript.RSTextureView.() -> Unit = defaultInit): android.renderscript.RSTextureView =
  addActivityTopLevelView(android.renderscript.RSTextureView(this), init)

public fun ViewManager.pagerTabStrip(init: android.support.v4.view.PagerTabStrip.() -> Unit = defaultInit): android.support.v4.view.PagerTabStrip =
  addView(android.support.v4.view.PagerTabStrip(dslContext), init, this)
public fun Context.pagerTabStrip(init: android.support.v4.view.PagerTabStrip.() -> Unit = defaultInit): android.support.v4.view.PagerTabStrip =
  addContextTopLevelView(android.support.v4.view.PagerTabStrip(this), init)
public fun Activity.pagerTabStrip(init: android.support.v4.view.PagerTabStrip.() -> Unit = defaultInit): android.support.v4.view.PagerTabStrip =
  addActivityTopLevelView(android.support.v4.view.PagerTabStrip(this), init)

public fun ViewManager.pagerTitleStrip(init: android.support.v4.view.PagerTitleStrip.() -> Unit = defaultInit): android.support.v4.view.PagerTitleStrip =
  addView(android.support.v4.view.PagerTitleStrip(dslContext), init, this)
public fun Context.pagerTitleStrip(init: android.support.v4.view.PagerTitleStrip.() -> Unit = defaultInit): android.support.v4.view.PagerTitleStrip =
  addContextTopLevelView(android.support.v4.view.PagerTitleStrip(this), init)
public fun Activity.pagerTitleStrip(init: android.support.v4.view.PagerTitleStrip.() -> Unit = defaultInit): android.support.v4.view.PagerTitleStrip =
  addActivityTopLevelView(android.support.v4.view.PagerTitleStrip(this), init)

public fun ViewManager.contentLoadingProgressBar(init: android.support.v4.widget.ContentLoadingProgressBar.() -> Unit = defaultInit): android.support.v4.widget.ContentLoadingProgressBar =
  addView(android.support.v4.widget.ContentLoadingProgressBar(dslContext), init, this)
public fun Context.contentLoadingProgressBar(init: android.support.v4.widget.ContentLoadingProgressBar.() -> Unit = defaultInit): android.support.v4.widget.ContentLoadingProgressBar =
  addContextTopLevelView(android.support.v4.widget.ContentLoadingProgressBar(this), init)
public fun Activity.contentLoadingProgressBar(init: android.support.v4.widget.ContentLoadingProgressBar.() -> Unit = defaultInit): android.support.v4.widget.ContentLoadingProgressBar =
  addActivityTopLevelView(android.support.v4.widget.ContentLoadingProgressBar(this), init)

public fun ViewManager.swipeRefreshLayout(init: android.support.v4.widget.SwipeRefreshLayout.() -> Unit = defaultInit): android.support.v4.widget.SwipeRefreshLayout =
  addView(android.support.v4.widget.SwipeRefreshLayout(dslContext), init, this)
public fun Context.swipeRefreshLayout(init: android.support.v4.widget.SwipeRefreshLayout.() -> Unit = defaultInit): android.support.v4.widget.SwipeRefreshLayout =
  addContextTopLevelView(android.support.v4.widget.SwipeRefreshLayout(this), init)
public fun Activity.swipeRefreshLayout(init: android.support.v4.widget.SwipeRefreshLayout.() -> Unit = defaultInit): android.support.v4.widget.SwipeRefreshLayout =
...
public fun ViewManager.fragmentTabHost(init: _FragmentTabHost.() -> Unit = defaultInit): android.support.v4.app.FragmentTabHost =
  addView(_FragmentTabHost(dslContext), init, this)
public fun Context.fragmentTabHost(init: _FragmentTabHost.() -> Unit = defaultInit): android.support.v4.app.FragmentTabHost =
  addContextTopLevelView(_FragmentTabHost(this), init)
public fun Activity.fragmentTabHost(init: _FragmentTabHost.() -> Unit = defaultInit): android.support.v4.app.FragmentTabHost =
  addActivityTopLevelView(_FragmentTabHost(this), init)

public fun ViewManager.viewPager(init: _ViewPager.() -> Unit = defaultInit): android.support.v4.view.ViewPager =
  addView(_ViewPager(dslContext), init, this)
public fun Context.viewPager(init: _ViewPager.() -> Unit = defaultInit): android.support.v4.view.ViewPager =
  addContextTopLevelView(_ViewPager(this), init)
public fun Activity.viewPager(init: _ViewPager.() -> Unit = defaultInit): android.support.v4.view.ViewPager =
  addActivityTopLevelView(_ViewPager(this), init)

public fun ViewManager.drawerLayout(init: _DrawerLayout.() -> Unit = defaultInit): android.support.v4.widget.DrawerLayout =
  addView(_DrawerLayout(dslContext), init, this)
public fun Context.drawerLayout(init: _DrawerLayout.() -> Unit = defaultInit): android.support.v4.widget.DrawerLayout =
  addContextTopLevelView(_DrawerLayout(this), init)
public fun Activity.drawerLayout(init: _DrawerLayout.() -> Unit = defaultInit): android.support.v4.widget.DrawerLayout =
  addActivityTopLevelView(_DrawerLayout(this), init)

public fun ViewManager.slidingPaneLayout(init: _SlidingPaneLayout.() -> Unit = defaultInit): android.support.v4.widget.SlidingPaneLayout =
  addView(_SlidingPaneLayout(dslContext), init, this)
public fun Context.slidingPaneLayout(init: _SlidingPaneLayout.() -> Unit = defaultInit): android.support.v4.widget.SlidingPaneLayout =
  addContextTopLevelView(_SlidingPaneLayout(this), init)
public fun Activity.slidingPaneLayout(init: _SlidingPaneLayout.() -> Unit = defaultInit): android.support.v4.widget.SlidingPaneLayout =
