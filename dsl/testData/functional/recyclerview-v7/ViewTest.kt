...
public inline fun ViewManager.recyclerViewSupport(
        inlineOptions(InlineOption.ONLY_LOCAL_RETURN) init: _RecyclerViewSupport.() -> Unit
): android.support.v7.widget.RecyclerView = addView<android.support.v7.widget.RecyclerView> {
    ctx ->
...
public inline fun Context.recyclerViewSupport(
        inlineOptions(InlineOption.ONLY_LOCAL_RETURN) init: _RecyclerViewSupport.() -> Unit
): android.support.v7.widget.RecyclerView = addView<android.support.v7.widget.RecyclerView> {
    ctx ->
    val view = _RecyclerViewSupport(ctx)
...
public inline fun Activity.recyclerViewSupport(
        inlineOptions(InlineOption.ONLY_LOCAL_RETURN) init: _RecyclerViewSupport.() -> Unit
): android.support.v7.widget.RecyclerView = addView<android.support.v7.widget.RecyclerView> {
    ctx ->
    val view = _RecyclerViewSupport(ctx)
