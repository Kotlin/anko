public fun android.gesture.GestureOverlayView.onGesturePerformed(l: (android.gesture.GestureOverlayView?, android.gesture.Gesture?) -> Unit): Unit = addOnGesturePerformedListener(l)

public fun android.media.tv.TvView.onUnhandledInputEvent(l: (android.view.InputEvent?) -> Boolean): Unit = setOnUnhandledInputEventListener(l)

public fun android.support.v4.app.FragmentTabHost.onTabChanged(l: (String?) -> Unit): Unit = setOnTabChangedListener(l)
...
public fun android.view.View.onApplyWindowInsets(l: (android.view.View?, android.view.WindowInsets?) -> android.view.WindowInsets?): Unit = setOnApplyWindowInsetsListener(l)
...
public fun android.widget.ActionMenuView.onMenuItemClick(l: (android.view.MenuItem?) -> Boolean): Unit = setOnMenuItemClickListener(l)
...
public fun android.widget.AutoCompleteTextView.onDismiss(l: () -> Unit): Unit = setOnDismissListener(l)
...
public fun android.widget.CalendarView.onDateChange(l: (android.widget.CalendarView?, Int, Int, Int) -> Unit): Unit = setOnDateChangeListener(l)

public fun android.widget.Chronometer.onChronometerTick(l: (android.widget.Chronometer?) -> Unit): Unit = setOnChronometerTickListener(l)

public fun android.widget.CompoundButton.onCheckedChange(l: (android.widget.CompoundButton?, Boolean) -> Unit): Unit = setOnCheckedChangeListener(l)

public fun android.widget.ExpandableListView.onChildClick(l: (android.widget.ExpandableListView?, android.view.View?, Int, Int, Long) -> Boolean): Unit = setOnChildClickListener(l)

public fun android.widget.ExpandableListView.onGroupClick(l: (android.widget.ExpandableListView?, android.view.View?, Int, Long) -> Boolean): Unit = setOnGroupClickListener(l)

public fun android.widget.ExpandableListView.onGroupCollapse(l: (Int) -> Unit): Unit = setOnGroupCollapseListener(l)

public fun android.widget.ExpandableListView.onGroupExpand(l: (Int) -> Unit): Unit = setOnGroupExpandListener(l)

public fun android.widget.ExpandableListView.onItemClick(l: (android.widget.AdapterView<*>?, android.view.View?, Int, Long) -> Unit): Unit = setOnItemClickListener(l)
...
public fun android.widget.RatingBar.onRatingBarChange(l: (android.widget.RatingBar?, Float, Boolean) -> Unit): Unit = setOnRatingBarChangeListener(l)
...
public fun android.widget.Spinner.onItemClick(l: (android.widget.AdapterView<*>?, android.view.View?, Int, Long) -> Unit): Unit = setOnItemClickListener(l)

public fun android.widget.TabHost.onTabChanged(l: (String?) -> Unit): Unit = setOnTabChangedListener(l)

public fun android.widget.TextView.onEditorAction(l: (android.widget.TextView?, Int, android.view.KeyEvent?) -> Boolean): Unit = setOnEditorActionListener(l)

public fun android.widget.TimePicker.onTimeChanged(l: (android.widget.TimePicker?, Int, Int) -> Unit): Unit = setOnTimeChangedListener(l)

public fun android.widget.Toolbar.onMenuItemClick(l: (android.view.MenuItem?) -> Boolean): Unit = setOnMenuItemClickListener(l)

public fun android.widget.VideoView.onCompletion(l: (android.media.MediaPlayer?) -> Unit): Unit = setOnCompletionListener(l)

public fun android.widget.VideoView.onError(l: (android.media.MediaPlayer?, Int, Int) -> Boolean): Unit = setOnErrorListener(l)

public fun android.widget.VideoView.onInfo(l: (android.media.MediaPlayer?, Int, Int) -> Boolean): Unit = setOnInfoListener(l)
