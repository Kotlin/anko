...
public var TextView.textSizeDimen: Int
    ...
    set(value) {
        setTextSize(TypedValue.COMPLEX_UNIT_PX, context.resources.getDimension(value))
    }
...
public inline fun android.widget.RelativeLayout.LayoutParams.topOf(v: View): Unit = addRule(android.widget.RelativeLayout.ABOVE, v.id)
@suppress("NOTHING_TO_INLINE")
public inline fun android.widget.RelativeLayout.LayoutParams.above(v: View): Unit = addRule(android.widget.RelativeLayout.ABOVE, v.id)
@suppress("NOTHING_TO_INLINE")
public inline fun android.widget.RelativeLayout.LayoutParams.below(v: View): Unit = addRule(android.widget.RelativeLayout.BELOW, v.id)
@suppress("NOTHING_TO_INLINE")
public inline fun android.widget.RelativeLayout.LayoutParams.bottomOf(v: View): Unit = addRule(android.widget.RelativeLayout.BELOW, v.id)
@suppress("NOTHING_TO_INLINE")
public inline fun android.widget.RelativeLayout.LayoutParams.leftOf(v: View): Unit = addRule(android.widget.RelativeLayout.LEFT_OF, v.id)
@suppress("NOTHING_TO_INLINE")
public inline fun android.widget.RelativeLayout.LayoutParams.rightOf(v: View): Unit = addRule(android.widget.RelativeLayout.RIGHT_OF, v.id)
@suppress("NOTHING_TO_INLINE")
public inline fun android.widget.RelativeLayout.LayoutParams.sameLeft(v: View): Unit = addRule(android.widget.RelativeLayout.ALIGN_LEFT, v.id)
@suppress("NOTHING_TO_INLINE")
public inline fun android.widget.RelativeLayout.LayoutParams.sameTop(v: View): Unit = addRule(android.widget.RelativeLayout.ALIGN_TOP, v.id)
@suppress("NOTHING_TO_INLINE")
public inline fun android.widget.RelativeLayout.LayoutParams.sameRight(v: View): Unit = addRule(android.widget.RelativeLayout.ALIGN_RIGHT, v.id)
@suppress("NOTHING_TO_INLINE")
public inline fun android.widget.RelativeLayout.LayoutParams.sameBottom(v: View): Unit = addRule(android.widget.RelativeLayout.ALIGN_BOTTOM, v.id)
