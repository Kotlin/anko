...
inline fun ViewManager.mediaRouteButton(theme: Int = 0, init: (@AnkoViewDslMarker android.app.MediaRouteButton).() -> Unit): android.app.MediaRouteButton {
...
inline fun ViewManager.gestureOverlayView(theme: Int = 0, init: (@AnkoViewDslMarker android.gesture.GestureOverlayView).() -> Unit): android.gesture.GestureOverlayView {
...
inline fun Context.gestureOverlayView(theme: Int = 0, init: (@AnkoViewDslMarker android.gesture.GestureOverlayView).() -> Unit): android.gesture.GestureOverlayView {
    return ankoView(`$$Anko$Factories$Sdk25View`.GESTURE_OVERLAY_VIEW, theme) { init() }
}

inline fun Activity.gestureOverlayView(theme: Int = 0): android.gesture.GestureOverlayView = gestureOverlayView(theme) {}
inline fun Activity.gestureOverlayView(theme: Int = 0, init: (@AnkoViewDslMarker android.gesture.GestureOverlayView).() -> Unit): android.gesture.GestureOverlayView {
    return ankoView(`$$Anko$Factories$Sdk25View`.GESTURE_OVERLAY_VIEW, theme) { init() }
}

inline fun ViewManager.extractEditText(theme: Int = 0): android.inputmethodservice.ExtractEditText = extractEditText(theme) {}
inline fun ViewManager.extractEditText(theme: Int = 0, init: (@AnkoViewDslMarker android.inputmethodservice.ExtractEditText).() -> Unit): android.inputmethodservice.ExtractEditText {
...
inline fun ViewManager.tvView(theme: Int = 0, init: (@AnkoViewDslMarker android.media.tv.TvView).() -> Unit): android.media.tv.TvView {
...
inline fun Context.tvView(theme: Int = 0, init: (@AnkoViewDslMarker android.media.tv.TvView).() -> Unit): android.media.tv.TvView {
    return ankoView(`$$Anko$Factories$Sdk25View`.TV_VIEW, theme) { init() }
}

inline fun Activity.tvView(theme: Int = 0): android.media.tv.TvView = tvView(theme) {}
inline fun Activity.tvView(theme: Int = 0, init: (@AnkoViewDslMarker android.media.tv.TvView).() -> Unit): android.media.tv.TvView {
    return ankoView(`$$Anko$Factories$Sdk25View`.TV_VIEW, theme) { init() }
}

inline fun ViewManager.gLSurfaceView(theme: Int = 0): android.opengl.GLSurfaceView = gLSurfaceView(theme) {}
inline fun ViewManager.gLSurfaceView(theme: Int = 0, init: (@AnkoViewDslMarker android.opengl.GLSurfaceView).() -> Unit): android.opengl.GLSurfaceView {
...
inline fun ViewManager.surfaceView(theme: Int = 0, init: (@AnkoViewDslMarker android.view.SurfaceView).() -> Unit): android.view.SurfaceView {
...
inline fun ViewManager.textureView(theme: Int = 0, init: (@AnkoViewDslMarker android.view.TextureView).() -> Unit): android.view.TextureView {
...
inline fun ViewManager.view(theme: Int = 0, init: (@AnkoViewDslMarker android.view.View).() -> Unit): android.view.View {
...
inline fun ViewManager.viewStub(theme: Int = 0, init: (@AnkoViewDslMarker android.view.ViewStub).() -> Unit): android.view.ViewStub {
...
inline fun ViewManager.adapterViewFlipper(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.AdapterViewFlipper).() -> Unit): android.widget.AdapterViewFlipper {
...
inline fun Context.adapterViewFlipper(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.AdapterViewFlipper).() -> Unit): android.widget.AdapterViewFlipper {
    return ankoView(`$$Anko$Factories$Sdk25View`.ADAPTER_VIEW_FLIPPER, theme) { init() }
}

inline fun Activity.adapterViewFlipper(theme: Int = 0): android.widget.AdapterViewFlipper = adapterViewFlipper(theme) {}
inline fun Activity.adapterViewFlipper(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.AdapterViewFlipper).() -> Unit): android.widget.AdapterViewFlipper {
    return ankoView(`$$Anko$Factories$Sdk25View`.ADAPTER_VIEW_FLIPPER, theme) { init() }
}

inline fun ViewManager.analogClock(theme: Int = 0): android.widget.AnalogClock = analogClock(theme) {}
inline fun ViewManager.analogClock(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.AnalogClock).() -> Unit): android.widget.AnalogClock {
...
inline fun ViewManager.autoCompleteTextView(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.AutoCompleteTextView).() -> Unit): android.widget.AutoCompleteTextView {
...
inline fun ViewManager.button(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.Button).() -> Unit): android.widget.Button {
...
inline fun ViewManager.button(text: CharSequence?, theme: Int = 0, init: (@AnkoViewDslMarker android.widget.Button).() -> Unit): android.widget.Button {
    return ankoView(`$$Anko$Factories$Sdk25View`.BUTTON, theme) {
        init()
        setText(text)
    }
...
inline fun ViewManager.button(text: Int, theme: Int = 0, init: (@AnkoViewDslMarker android.widget.Button).() -> Unit): android.widget.Button {
    return ankoView(`$$Anko$Factories$Sdk25View`.BUTTON, theme) {
        init()
        setText(text)
    }
...
inline fun ViewManager.calendarView(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.CalendarView).() -> Unit): android.widget.CalendarView {
...
inline fun Context.calendarView(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.CalendarView).() -> Unit): android.widget.CalendarView {
    return ankoView(`$$Anko$Factories$Sdk25View`.CALENDAR_VIEW, theme) { init() }
}

inline fun Activity.calendarView(theme: Int = 0): android.widget.CalendarView = calendarView(theme) {}
inline fun Activity.calendarView(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.CalendarView).() -> Unit): android.widget.CalendarView {
    return ankoView(`$$Anko$Factories$Sdk25View`.CALENDAR_VIEW, theme) { init() }
}

inline fun ViewManager.checkBox(theme: Int = 0): android.widget.CheckBox = checkBox(theme) {}
inline fun ViewManager.checkBox(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.CheckBox).() -> Unit): android.widget.CheckBox {
...
inline fun ViewManager.checkBox(text: CharSequence?, theme: Int = 0, init: (@AnkoViewDslMarker android.widget.CheckBox).() -> Unit): android.widget.CheckBox {
    return ankoView(`$$Anko$Factories$Sdk25View`.CHECK_BOX, theme) {
        init()
        setText(text)
    }
...
inline fun ViewManager.checkBox(text: Int, theme: Int = 0, init: (@AnkoViewDslMarker android.widget.CheckBox).() -> Unit): android.widget.CheckBox {
    return ankoView(`$$Anko$Factories$Sdk25View`.CHECK_BOX, theme) {
        init()
        setText(text)
    }
...
inline fun ViewManager.checkBox(text: CharSequence?, checked: Boolean, theme: Int = 0, init: (@AnkoViewDslMarker android.widget.CheckBox).() -> Unit): android.widget.CheckBox {
    return ankoView(`$$Anko$Factories$Sdk25View`.CHECK_BOX, theme) {
        init()
        setText(text)
        setChecked(checked)
...
inline fun ViewManager.checkBox(text: Int, checked: Boolean, theme: Int = 0, init: (@AnkoViewDslMarker android.widget.CheckBox).() -> Unit): android.widget.CheckBox {
    return ankoView(`$$Anko$Factories$Sdk25View`.CHECK_BOX, theme) {
        init()
        setText(text)
        setChecked(checked)
...
inline fun ViewManager.checkedTextView(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.CheckedTextView).() -> Unit): android.widget.CheckedTextView {
...
inline fun ViewManager.chronometer(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.Chronometer).() -> Unit): android.widget.Chronometer {
...
inline fun ViewManager.datePicker(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.DatePicker).() -> Unit): android.widget.DatePicker {
...
inline fun Context.datePicker(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.DatePicker).() -> Unit): android.widget.DatePicker {
    return ankoView(`$$Anko$Factories$Sdk25View`.DATE_PICKER, theme) { init() }
}

inline fun Activity.datePicker(theme: Int = 0): android.widget.DatePicker = datePicker(theme) {}
inline fun Activity.datePicker(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.DatePicker).() -> Unit): android.widget.DatePicker {
    return ankoView(`$$Anko$Factories$Sdk25View`.DATE_PICKER, theme) { init() }
}

inline fun ViewManager.dialerFilter(theme: Int = 0): android.widget.DialerFilter = dialerFilter(theme) {}
inline fun ViewManager.dialerFilter(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.DialerFilter).() -> Unit): android.widget.DialerFilter {
...
inline fun Context.dialerFilter(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.DialerFilter).() -> Unit): android.widget.DialerFilter {
    return ankoView(`$$Anko$Factories$Sdk25View`.DIALER_FILTER, theme) { init() }
}

inline fun Activity.dialerFilter(theme: Int = 0): android.widget.DialerFilter = dialerFilter(theme) {}
inline fun Activity.dialerFilter(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.DialerFilter).() -> Unit): android.widget.DialerFilter {
    return ankoView(`$$Anko$Factories$Sdk25View`.DIALER_FILTER, theme) { init() }
}

inline fun ViewManager.digitalClock(theme: Int = 0): android.widget.DigitalClock = digitalClock(theme) {}
inline fun ViewManager.digitalClock(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.DigitalClock).() -> Unit): android.widget.DigitalClock {
...
inline fun ViewManager.editText(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.EditText).() -> Unit): android.widget.EditText {
...
inline fun ViewManager.editText(text: CharSequence?, theme: Int = 0, init: (@AnkoViewDslMarker android.widget.EditText).() -> Unit): android.widget.EditText {
    return ankoView(`$$Anko$Factories$Sdk25View`.EDIT_TEXT, theme) {
        init()
        setText(text)
    }
...
inline fun ViewManager.editText(text: Int, theme: Int = 0, init: (@AnkoViewDslMarker android.widget.EditText).() -> Unit): android.widget.EditText {
    return ankoView(`$$Anko$Factories$Sdk25View`.EDIT_TEXT, theme) {
        init()
        setText(text)
    }
...
inline fun ViewManager.expandableListView(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.ExpandableListView).() -> Unit): android.widget.ExpandableListView {
...
inline fun Context.expandableListView(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.ExpandableListView).() -> Unit): android.widget.ExpandableListView {
    return ankoView(`$$Anko$Factories$Sdk25View`.EXPANDABLE_LIST_VIEW, theme) { init() }
}

inline fun Activity.expandableListView(theme: Int = 0): android.widget.ExpandableListView = expandableListView(theme) {}
inline fun Activity.expandableListView(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.ExpandableListView).() -> Unit): android.widget.ExpandableListView {
    return ankoView(`$$Anko$Factories$Sdk25View`.EXPANDABLE_LIST_VIEW, theme) { init() }
}

inline fun ViewManager.imageButton(theme: Int = 0): android.widget.ImageButton = imageButton(theme) {}
inline fun ViewManager.imageButton(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.ImageButton).() -> Unit): android.widget.ImageButton {
...
inline fun ViewManager.imageButton(imageDrawable: android.graphics.drawable.Drawable?, theme: Int = 0, init: (@AnkoViewDslMarker android.widget.ImageButton).() -> Unit): android.widget.ImageButton {
    return ankoView(`$$Anko$Factories$Sdk25View`.IMAGE_BUTTON, theme) {
        init()
        setImageDrawable(imageDrawable)
    }
...
inline fun ViewManager.imageButton(imageResource: Int, theme: Int = 0, init: (@AnkoViewDslMarker android.widget.ImageButton).() -> Unit): android.widget.ImageButton {
    return ankoView(`$$Anko$Factories$Sdk25View`.IMAGE_BUTTON, theme) {
        init()
        setImageResource(imageResource)
    }
...
inline fun ViewManager.imageView(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.ImageView).() -> Unit): android.widget.ImageView {
...
inline fun ViewManager.imageView(imageDrawable: android.graphics.drawable.Drawable?, theme: Int = 0, init: (@AnkoViewDslMarker android.widget.ImageView).() -> Unit): android.widget.ImageView {
    return ankoView(`$$Anko$Factories$Sdk25View`.IMAGE_VIEW, theme) {
        init()
        setImageDrawable(imageDrawable)
    }
...
inline fun ViewManager.imageView(imageResource: Int, theme: Int = 0, init: (@AnkoViewDslMarker android.widget.ImageView).() -> Unit): android.widget.ImageView {
    return ankoView(`$$Anko$Factories$Sdk25View`.IMAGE_VIEW, theme) {
        init()
        setImageResource(imageResource)
    }
...
inline fun ViewManager.listView(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.ListView).() -> Unit): android.widget.ListView {
...
inline fun Context.listView(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.ListView).() -> Unit): android.widget.ListView {
    return ankoView(`$$Anko$Factories$Sdk25View`.LIST_VIEW, theme) { init() }
}

inline fun Activity.listView(theme: Int = 0): android.widget.ListView = listView(theme) {}
inline fun Activity.listView(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.ListView).() -> Unit): android.widget.ListView {
    return ankoView(`$$Anko$Factories$Sdk25View`.LIST_VIEW, theme) { init() }
}
...
inline fun ViewManager.multiAutoCompleteTextView(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.MultiAutoCompleteTextView).() -> Unit): android.widget.MultiAutoCompleteTextView {
...
inline fun ViewManager.numberPicker(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.NumberPicker).() -> Unit): android.widget.NumberPicker {
...
inline fun Context.numberPicker(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.NumberPicker).() -> Unit): android.widget.NumberPicker {
    return ankoView(`$$Anko$Factories$Sdk25View`.NUMBER_PICKER, theme) { init() }
}

inline fun Activity.numberPicker(theme: Int = 0): android.widget.NumberPicker = numberPicker(theme) {}
inline fun Activity.numberPicker(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.NumberPicker).() -> Unit): android.widget.NumberPicker {
    return ankoView(`$$Anko$Factories$Sdk25View`.NUMBER_PICKER, theme) { init() }
}

inline fun ViewManager.progressBar(theme: Int = 0): android.widget.ProgressBar = progressBar(theme) {}
inline fun ViewManager.progressBar(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.ProgressBar).() -> Unit): android.widget.ProgressBar {
...
inline fun ViewManager.quickContactBadge(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.QuickContactBadge).() -> Unit): android.widget.QuickContactBadge {
...
inline fun ViewManager.radioButton(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.RadioButton).() -> Unit): android.widget.RadioButton {
...
inline fun ViewManager.ratingBar(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.RatingBar).() -> Unit): android.widget.RatingBar {
...
inline fun ViewManager.searchView(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.SearchView).() -> Unit): android.widget.SearchView {
...
inline fun Context.searchView(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.SearchView).() -> Unit): android.widget.SearchView {
    return ankoView(`$$Anko$Factories$Sdk25View`.SEARCH_VIEW, theme) { init() }
}

inline fun Activity.searchView(theme: Int = 0): android.widget.SearchView = searchView(theme) {}
inline fun Activity.searchView(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.SearchView).() -> Unit): android.widget.SearchView {
    return ankoView(`$$Anko$Factories$Sdk25View`.SEARCH_VIEW, theme) { init() }
}

inline fun ViewManager.seekBar(theme: Int = 0): android.widget.SeekBar = seekBar(theme) {}
inline fun ViewManager.seekBar(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.SeekBar).() -> Unit): android.widget.SeekBar {
...
inline fun ViewManager.slidingDrawer(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.SlidingDrawer).() -> Unit): android.widget.SlidingDrawer {
...
inline fun Context.slidingDrawer(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.SlidingDrawer).() -> Unit): android.widget.SlidingDrawer {
    return ankoView(`$$Anko$Factories$Sdk25View`.SLIDING_DRAWER, theme) { init() }
}

inline fun Activity.slidingDrawer(theme: Int = 0): android.widget.SlidingDrawer = slidingDrawer(theme) {}
inline fun Activity.slidingDrawer(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.SlidingDrawer).() -> Unit): android.widget.SlidingDrawer {
    return ankoView(`$$Anko$Factories$Sdk25View`.SLIDING_DRAWER, theme) { init() }
}

inline fun ViewManager.space(theme: Int = 0): android.widget.Space = space(theme) {}
inline fun ViewManager.space(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.Space).() -> Unit): android.widget.Space {
...
inline fun ViewManager.spinner(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.Spinner).() -> Unit): android.widget.Spinner {
...
inline fun Context.spinner(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.Spinner).() -> Unit): android.widget.Spinner {
    return ankoView(`$$Anko$Factories$Sdk25View`.SPINNER, theme) { init() }
}

inline fun Activity.spinner(theme: Int = 0): android.widget.Spinner = spinner(theme) {}
inline fun Activity.spinner(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.Spinner).() -> Unit): android.widget.Spinner {
    return ankoView(`$$Anko$Factories$Sdk25View`.SPINNER, theme) { init() }
}

inline fun ViewManager.stackView(theme: Int = 0): android.widget.StackView = stackView(theme) {}
inline fun ViewManager.stackView(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.StackView).() -> Unit): android.widget.StackView {
...
inline fun Context.stackView(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.StackView).() -> Unit): android.widget.StackView {
    return ankoView(`$$Anko$Factories$Sdk25View`.STACK_VIEW, theme) { init() }
}

inline fun Activity.stackView(theme: Int = 0): android.widget.StackView = stackView(theme) {}
inline fun Activity.stackView(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.StackView).() -> Unit): android.widget.StackView {
    return ankoView(`$$Anko$Factories$Sdk25View`.STACK_VIEW, theme) { init() }
}

inline fun ViewManager.switch(theme: Int = 0): android.widget.Switch = switch(theme) {}
inline fun ViewManager.switch(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.Switch).() -> Unit): android.widget.Switch {
...
inline fun ViewManager.tabHost(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.TabHost).() -> Unit): android.widget.TabHost {
...
inline fun Context.tabHost(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.TabHost).() -> Unit): android.widget.TabHost {
    return ankoView(`$$Anko$Factories$Sdk25View`.TAB_HOST, theme) { init() }
}

inline fun Activity.tabHost(theme: Int = 0): android.widget.TabHost = tabHost(theme) {}
inline fun Activity.tabHost(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.TabHost).() -> Unit): android.widget.TabHost {
    return ankoView(`$$Anko$Factories$Sdk25View`.TAB_HOST, theme) { init() }
}

inline fun ViewManager.tabWidget(theme: Int = 0): android.widget.TabWidget = tabWidget(theme) {}
inline fun ViewManager.tabWidget(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.TabWidget).() -> Unit): android.widget.TabWidget {
...
inline fun Context.tabWidget(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.TabWidget).() -> Unit): android.widget.TabWidget {
    return ankoView(`$$Anko$Factories$Sdk25View`.TAB_WIDGET, theme) { init() }
}

inline fun Activity.tabWidget(theme: Int = 0): android.widget.TabWidget = tabWidget(theme) {}
inline fun Activity.tabWidget(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.TabWidget).() -> Unit): android.widget.TabWidget {
    return ankoView(`$$Anko$Factories$Sdk25View`.TAB_WIDGET, theme) { init() }
}

inline fun ViewManager.textClock(theme: Int = 0): android.widget.TextClock = textClock(theme) {}
inline fun ViewManager.textClock(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.TextClock).() -> Unit): android.widget.TextClock {
...
inline fun ViewManager.textView(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.TextView).() -> Unit): android.widget.TextView {
...
inline fun ViewManager.textView(text: CharSequence?, theme: Int = 0, init: (@AnkoViewDslMarker android.widget.TextView).() -> Unit): android.widget.TextView {
    return ankoView(`$$Anko$Factories$Sdk25View`.TEXT_VIEW, theme) {
        init()
        setText(text)
    }
...
inline fun ViewManager.textView(text: Int, theme: Int = 0, init: (@AnkoViewDslMarker android.widget.TextView).() -> Unit): android.widget.TextView {
    return ankoView(`$$Anko$Factories$Sdk25View`.TEXT_VIEW, theme) {
        init()
        setText(text)
    }
...
inline fun ViewManager.timePicker(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.TimePicker).() -> Unit): android.widget.TimePicker {
...
inline fun Context.timePicker(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.TimePicker).() -> Unit): android.widget.TimePicker {
    return ankoView(`$$Anko$Factories$Sdk25View`.TIME_PICKER, theme) { init() }
}

inline fun Activity.timePicker(theme: Int = 0): android.widget.TimePicker = timePicker(theme) {}
inline fun Activity.timePicker(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.TimePicker).() -> Unit): android.widget.TimePicker {
    return ankoView(`$$Anko$Factories$Sdk25View`.TIME_PICKER, theme) { init() }
}

inline fun ViewManager.toggleButton(theme: Int = 0): android.widget.ToggleButton = toggleButton(theme) {}
inline fun ViewManager.toggleButton(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.ToggleButton).() -> Unit): android.widget.ToggleButton {
...
inline fun ViewManager.twoLineListItem(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.TwoLineListItem).() -> Unit): android.widget.TwoLineListItem {
...
inline fun Context.twoLineListItem(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.TwoLineListItem).() -> Unit): android.widget.TwoLineListItem {
    return ankoView(`$$Anko$Factories$Sdk25View`.TWO_LINE_LIST_ITEM, theme) { init() }
}

inline fun Activity.twoLineListItem(theme: Int = 0): android.widget.TwoLineListItem = twoLineListItem(theme) {}
inline fun Activity.twoLineListItem(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.TwoLineListItem).() -> Unit): android.widget.TwoLineListItem {
    return ankoView(`$$Anko$Factories$Sdk25View`.TWO_LINE_LIST_ITEM, theme) { init() }
}

inline fun ViewManager.videoView(theme: Int = 0): android.widget.VideoView = videoView(theme) {}
inline fun ViewManager.videoView(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.VideoView).() -> Unit): android.widget.VideoView {
...
inline fun ViewManager.viewFlipper(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.ViewFlipper).() -> Unit): android.widget.ViewFlipper {
...
inline fun Context.viewFlipper(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.ViewFlipper).() -> Unit): android.widget.ViewFlipper {
    return ankoView(`$$Anko$Factories$Sdk25View`.VIEW_FLIPPER, theme) { init() }
}

inline fun Activity.viewFlipper(theme: Int = 0): android.widget.ViewFlipper = viewFlipper(theme) {}
inline fun Activity.viewFlipper(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.ViewFlipper).() -> Unit): android.widget.ViewFlipper {
    return ankoView(`$$Anko$Factories$Sdk25View`.VIEW_FLIPPER, theme) { init() }
}

inline fun ViewManager.zoomButton(theme: Int = 0): android.widget.ZoomButton = zoomButton(theme) {}
inline fun ViewManager.zoomButton(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.ZoomButton).() -> Unit): android.widget.ZoomButton {
...
inline fun ViewManager.zoomControls(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.ZoomControls).() -> Unit): android.widget.ZoomControls {
...
inline fun Context.zoomControls(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.ZoomControls).() -> Unit): android.widget.ZoomControls {
    return ankoView(`$$Anko$Factories$Sdk25View`.ZOOM_CONTROLS, theme) { init() }
}

inline fun Activity.zoomControls(theme: Int = 0): android.widget.ZoomControls = zoomControls(theme) {}
inline fun Activity.zoomControls(theme: Int = 0, init: (@AnkoViewDslMarker android.widget.ZoomControls).() -> Unit): android.widget.ZoomControls {
    return ankoView(`$$Anko$Factories$Sdk25View`.ZOOM_CONTROLS, theme) { init() }
}
...
inline fun ViewManager.appWidgetHostView(theme: Int = 0, init: (@AnkoViewDslMarker _AppWidgetHostView).() -> Unit): android.appwidget.AppWidgetHostView {
...
inline fun Context.appWidgetHostView(theme: Int = 0, init: (@AnkoViewDslMarker _AppWidgetHostView).() -> Unit): android.appwidget.AppWidgetHostView {
    return ankoView(`$$Anko$Factories$Sdk25ViewGroup`.APP_WIDGET_HOST_VIEW, theme) { init() }
}

inline fun Activity.appWidgetHostView(theme: Int = 0): android.appwidget.AppWidgetHostView = appWidgetHostView(theme) {}
inline fun Activity.appWidgetHostView(theme: Int = 0, init: (@AnkoViewDslMarker _AppWidgetHostView).() -> Unit): android.appwidget.AppWidgetHostView {
    return ankoView(`$$Anko$Factories$Sdk25ViewGroup`.APP_WIDGET_HOST_VIEW, theme) { init() }
}

inline fun ViewManager.webView(theme: Int = 0): android.webkit.WebView = webView(theme) {}
inline fun ViewManager.webView(theme: Int = 0, init: (@AnkoViewDslMarker _WebView).() -> Unit): android.webkit.WebView {
    return ankoView(`$$Anko$Factories$Sdk25ViewGroup`.WEB_VIEW, theme) { init() }
}

inline fun Context.webView(theme: Int = 0): android.webkit.WebView = webView(theme) {}
inline fun Context.webView(theme: Int = 0, init: (@AnkoViewDslMarker _WebView).() -> Unit): android.webkit.WebView {
    return ankoView(`$$Anko$Factories$Sdk25ViewGroup`.WEB_VIEW, theme) { init() }
}

inline fun Activity.webView(theme: Int = 0): android.webkit.WebView = webView(theme) {}
inline fun Activity.webView(theme: Int = 0, init: (@AnkoViewDslMarker _WebView).() -> Unit): android.webkit.WebView {
    return ankoView(`$$Anko$Factories$Sdk25ViewGroup`.WEB_VIEW, theme) { init() }
}

inline fun ViewManager.absoluteLayout(theme: Int = 0): android.widget.AbsoluteLayout = absoluteLayout(theme) {}
inline fun ViewManager.absoluteLayout(theme: Int = 0, init: (@AnkoViewDslMarker _AbsoluteLayout).() -> Unit): android.widget.AbsoluteLayout {
...
inline fun Context.absoluteLayout(theme: Int = 0, init: (@AnkoViewDslMarker _AbsoluteLayout).() -> Unit): android.widget.AbsoluteLayout {
    return ankoView(`$$Anko$Factories$Sdk25ViewGroup`.ABSOLUTE_LAYOUT, theme) { init() }
}

inline fun Activity.absoluteLayout(theme: Int = 0): android.widget.AbsoluteLayout = absoluteLayout(theme) {}
inline fun Activity.absoluteLayout(theme: Int = 0, init: (@AnkoViewDslMarker _AbsoluteLayout).() -> Unit): android.widget.AbsoluteLayout {
    return ankoView(`$$Anko$Factories$Sdk25ViewGroup`.ABSOLUTE_LAYOUT, theme) { init() }
}

inline fun ViewManager.actionMenuView(theme: Int = 0): android.widget.ActionMenuView = actionMenuView(theme) {}
inline fun ViewManager.actionMenuView(theme: Int = 0, init: (@AnkoViewDslMarker _ActionMenuView).() -> Unit): android.widget.ActionMenuView {
...
inline fun Context.actionMenuView(theme: Int = 0, init: (@AnkoViewDslMarker _ActionMenuView).() -> Unit): android.widget.ActionMenuView {
    return ankoView(`$$Anko$Factories$Sdk25ViewGroup`.ACTION_MENU_VIEW, theme) { init() }
}

inline fun Activity.actionMenuView(theme: Int = 0): android.widget.ActionMenuView = actionMenuView(theme) {}
inline fun Activity.actionMenuView(theme: Int = 0, init: (@AnkoViewDslMarker _ActionMenuView).() -> Unit): android.widget.ActionMenuView {
    return ankoView(`$$Anko$Factories$Sdk25ViewGroup`.ACTION_MENU_VIEW, theme) { init() }
}

inline fun ViewManager.frameLayout(theme: Int = 0): android.widget.FrameLayout = frameLayout(theme) {}
inline fun ViewManager.frameLayout(theme: Int = 0, init: (@AnkoViewDslMarker _FrameLayout).() -> Unit): android.widget.FrameLayout {
...
inline fun Context.frameLayout(theme: Int = 0, init: (@AnkoViewDslMarker _FrameLayout).() -> Unit): android.widget.FrameLayout {
    return ankoView(`$$Anko$Factories$Sdk25ViewGroup`.FRAME_LAYOUT, theme) { init() }
}

inline fun Activity.frameLayout(theme: Int = 0): android.widget.FrameLayout = frameLayout(theme) {}
inline fun Activity.frameLayout(theme: Int = 0, init: (@AnkoViewDslMarker _FrameLayout).() -> Unit): android.widget.FrameLayout {
    return ankoView(`$$Anko$Factories$Sdk25ViewGroup`.FRAME_LAYOUT, theme) { init() }
}

inline fun ViewManager.gallery(theme: Int = 0): android.widget.Gallery = gallery(theme) {}
inline fun ViewManager.gallery(theme: Int = 0, init: (@AnkoViewDslMarker _Gallery).() -> Unit): android.widget.Gallery {
...
inline fun Context.gallery(theme: Int = 0, init: (@AnkoViewDslMarker _Gallery).() -> Unit): android.widget.Gallery {
    return ankoView(`$$Anko$Factories$Sdk25ViewGroup`.GALLERY, theme) { init() }
}

inline fun Activity.gallery(theme: Int = 0): android.widget.Gallery = gallery(theme) {}
inline fun Activity.gallery(theme: Int = 0, init: (@AnkoViewDslMarker _Gallery).() -> Unit): android.widget.Gallery {
    return ankoView(`$$Anko$Factories$Sdk25ViewGroup`.GALLERY, theme) { init() }
}

inline fun ViewManager.gridLayout(theme: Int = 0): android.widget.GridLayout = gridLayout(theme) {}
inline fun ViewManager.gridLayout(theme: Int = 0, init: (@AnkoViewDslMarker _GridLayout).() -> Unit): android.widget.GridLayout {
...
inline fun Context.gridLayout(theme: Int = 0, init: (@AnkoViewDslMarker _GridLayout).() -> Unit): android.widget.GridLayout {
    return ankoView(`$$Anko$Factories$Sdk25ViewGroup`.GRID_LAYOUT, theme) { init() }
}

inline fun Activity.gridLayout(theme: Int = 0): android.widget.GridLayout = gridLayout(theme) {}
inline fun Activity.gridLayout(theme: Int = 0, init: (@AnkoViewDslMarker _GridLayout).() -> Unit): android.widget.GridLayout {
    return ankoView(`$$Anko$Factories$Sdk25ViewGroup`.GRID_LAYOUT, theme) { init() }
}

inline fun ViewManager.gridView(theme: Int = 0): android.widget.GridView = gridView(theme) {}
inline fun ViewManager.gridView(theme: Int = 0, init: (@AnkoViewDslMarker _GridView).() -> Unit): android.widget.GridView {
...
inline fun Context.gridView(theme: Int = 0, init: (@AnkoViewDslMarker _GridView).() -> Unit): android.widget.GridView {
    return ankoView(`$$Anko$Factories$Sdk25ViewGroup`.GRID_VIEW, theme) { init() }
}

inline fun Activity.gridView(theme: Int = 0): android.widget.GridView = gridView(theme) {}
inline fun Activity.gridView(theme: Int = 0, init: (@AnkoViewDslMarker _GridView).() -> Unit): android.widget.GridView {
    return ankoView(`$$Anko$Factories$Sdk25ViewGroup`.GRID_VIEW, theme) { init() }
}

inline fun ViewManager.horizontalScrollView(theme: Int = 0): android.widget.HorizontalScrollView = horizontalScrollView(theme) {}
inline fun ViewManager.horizontalScrollView(theme: Int = 0, init: (@AnkoViewDslMarker _HorizontalScrollView).() -> Unit): android.widget.HorizontalScrollView {
...
inline fun Context.horizontalScrollView(theme: Int = 0, init: (@AnkoViewDslMarker _HorizontalScrollView).() -> Unit): android.widget.HorizontalScrollView {
    return ankoView(`$$Anko$Factories$Sdk25ViewGroup`.HORIZONTAL_SCROLL_VIEW, theme) { init() }
}

inline fun Activity.horizontalScrollView(theme: Int = 0): android.widget.HorizontalScrollView = horizontalScrollView(theme) {}
inline fun Activity.horizontalScrollView(theme: Int = 0, init: (@AnkoViewDslMarker _HorizontalScrollView).() -> Unit): android.widget.HorizontalScrollView {
    return ankoView(`$$Anko$Factories$Sdk25ViewGroup`.HORIZONTAL_SCROLL_VIEW, theme) { init() }
}

inline fun ViewManager.imageSwitcher(theme: Int = 0): android.widget.ImageSwitcher = imageSwitcher(theme) {}
inline fun ViewManager.imageSwitcher(theme: Int = 0, init: (@AnkoViewDslMarker _ImageSwitcher).() -> Unit): android.widget.ImageSwitcher {
...
inline fun Context.imageSwitcher(theme: Int = 0, init: (@AnkoViewDslMarker _ImageSwitcher).() -> Unit): android.widget.ImageSwitcher {
    return ankoView(`$$Anko$Factories$Sdk25ViewGroup`.IMAGE_SWITCHER, theme) { init() }
}

inline fun Activity.imageSwitcher(theme: Int = 0): android.widget.ImageSwitcher = imageSwitcher(theme) {}
inline fun Activity.imageSwitcher(theme: Int = 0, init: (@AnkoViewDslMarker _ImageSwitcher).() -> Unit): android.widget.ImageSwitcher {
    return ankoView(`$$Anko$Factories$Sdk25ViewGroup`.IMAGE_SWITCHER, theme) { init() }
}

inline fun ViewManager.linearLayout(theme: Int = 0): android.widget.LinearLayout = linearLayout(theme) {}
inline fun ViewManager.linearLayout(theme: Int = 0, init: (@AnkoViewDslMarker _LinearLayout).() -> Unit): android.widget.LinearLayout {
...
inline fun Context.linearLayout(theme: Int = 0, init: (@AnkoViewDslMarker _LinearLayout).() -> Unit): android.widget.LinearLayout {
    return ankoView(`$$Anko$Factories$Sdk25ViewGroup`.LINEAR_LAYOUT, theme) { init() }
}

inline fun Activity.linearLayout(theme: Int = 0): android.widget.LinearLayout = linearLayout(theme) {}
inline fun Activity.linearLayout(theme: Int = 0, init: (@AnkoViewDslMarker _LinearLayout).() -> Unit): android.widget.LinearLayout {
    return ankoView(`$$Anko$Factories$Sdk25ViewGroup`.LINEAR_LAYOUT, theme) { init() }
}

inline fun ViewManager.radioGroup(theme: Int = 0): android.widget.RadioGroup = radioGroup(theme) {}
inline fun ViewManager.radioGroup(theme: Int = 0, init: (@AnkoViewDslMarker _RadioGroup).() -> Unit): android.widget.RadioGroup {
...
inline fun Context.radioGroup(theme: Int = 0, init: (@AnkoViewDslMarker _RadioGroup).() -> Unit): android.widget.RadioGroup {
    return ankoView(`$$Anko$Factories$Sdk25ViewGroup`.RADIO_GROUP, theme) { init() }
}

inline fun Activity.radioGroup(theme: Int = 0): android.widget.RadioGroup = radioGroup(theme) {}
inline fun Activity.radioGroup(theme: Int = 0, init: (@AnkoViewDslMarker _RadioGroup).() -> Unit): android.widget.RadioGroup {
    return ankoView(`$$Anko$Factories$Sdk25ViewGroup`.RADIO_GROUP, theme) { init() }
}

inline fun ViewManager.relativeLayout(theme: Int = 0): android.widget.RelativeLayout = relativeLayout(theme) {}
inline fun ViewManager.relativeLayout(theme: Int = 0, init: (@AnkoViewDslMarker _RelativeLayout).() -> Unit): android.widget.RelativeLayout {
...
inline fun Context.relativeLayout(theme: Int = 0, init: (@AnkoViewDslMarker _RelativeLayout).() -> Unit): android.widget.RelativeLayout {
    return ankoView(`$$Anko$Factories$Sdk25ViewGroup`.RELATIVE_LAYOUT, theme) { init() }
}

inline fun Activity.relativeLayout(theme: Int = 0): android.widget.RelativeLayout = relativeLayout(theme) {}
inline fun Activity.relativeLayout(theme: Int = 0, init: (@AnkoViewDslMarker _RelativeLayout).() -> Unit): android.widget.RelativeLayout {
    return ankoView(`$$Anko$Factories$Sdk25ViewGroup`.RELATIVE_LAYOUT, theme) { init() }
}

inline fun ViewManager.scrollView(theme: Int = 0): android.widget.ScrollView = scrollView(theme) {}
inline fun ViewManager.scrollView(theme: Int = 0, init: (@AnkoViewDslMarker _ScrollView).() -> Unit): android.widget.ScrollView {
...
inline fun Context.scrollView(theme: Int = 0, init: (@AnkoViewDslMarker _ScrollView).() -> Unit): android.widget.ScrollView {
    return ankoView(`$$Anko$Factories$Sdk25ViewGroup`.SCROLL_VIEW, theme) { init() }
}

inline fun Activity.scrollView(theme: Int = 0): android.widget.ScrollView = scrollView(theme) {}
inline fun Activity.scrollView(theme: Int = 0, init: (@AnkoViewDslMarker _ScrollView).() -> Unit): android.widget.ScrollView {
    return ankoView(`$$Anko$Factories$Sdk25ViewGroup`.SCROLL_VIEW, theme) { init() }
}

inline fun ViewManager.tableLayout(theme: Int = 0): android.widget.TableLayout = tableLayout(theme) {}
inline fun ViewManager.tableLayout(theme: Int = 0, init: (@AnkoViewDslMarker _TableLayout).() -> Unit): android.widget.TableLayout {
...
inline fun Context.tableLayout(theme: Int = 0, init: (@AnkoViewDslMarker _TableLayout).() -> Unit): android.widget.TableLayout {
    return ankoView(`$$Anko$Factories$Sdk25ViewGroup`.TABLE_LAYOUT, theme) { init() }
}

inline fun Activity.tableLayout(theme: Int = 0): android.widget.TableLayout = tableLayout(theme) {}
inline fun Activity.tableLayout(theme: Int = 0, init: (@AnkoViewDslMarker _TableLayout).() -> Unit): android.widget.TableLayout {
    return ankoView(`$$Anko$Factories$Sdk25ViewGroup`.TABLE_LAYOUT, theme) { init() }
}

inline fun ViewManager.tableRow(theme: Int = 0): android.widget.TableRow = tableRow(theme) {}
inline fun ViewManager.tableRow(theme: Int = 0, init: (@AnkoViewDslMarker _TableRow).() -> Unit): android.widget.TableRow {
...
inline fun Context.tableRow(theme: Int = 0, init: (@AnkoViewDslMarker _TableRow).() -> Unit): android.widget.TableRow {
    return ankoView(`$$Anko$Factories$Sdk25ViewGroup`.TABLE_ROW, theme) { init() }
}

inline fun Activity.tableRow(theme: Int = 0): android.widget.TableRow = tableRow(theme) {}
inline fun Activity.tableRow(theme: Int = 0, init: (@AnkoViewDslMarker _TableRow).() -> Unit): android.widget.TableRow {
    return ankoView(`$$Anko$Factories$Sdk25ViewGroup`.TABLE_ROW, theme) { init() }
}

inline fun ViewManager.textSwitcher(theme: Int = 0): android.widget.TextSwitcher = textSwitcher(theme) {}
inline fun ViewManager.textSwitcher(theme: Int = 0, init: (@AnkoViewDslMarker _TextSwitcher).() -> Unit): android.widget.TextSwitcher {
...
inline fun Context.textSwitcher(theme: Int = 0, init: (@AnkoViewDslMarker _TextSwitcher).() -> Unit): android.widget.TextSwitcher {
    return ankoView(`$$Anko$Factories$Sdk25ViewGroup`.TEXT_SWITCHER, theme) { init() }
}

inline fun Activity.textSwitcher(theme: Int = 0): android.widget.TextSwitcher = textSwitcher(theme) {}
inline fun Activity.textSwitcher(theme: Int = 0, init: (@AnkoViewDslMarker _TextSwitcher).() -> Unit): android.widget.TextSwitcher {
    return ankoView(`$$Anko$Factories$Sdk25ViewGroup`.TEXT_SWITCHER, theme) { init() }
}

inline fun ViewManager.toolbar(theme: Int = 0): android.widget.Toolbar = toolbar(theme) {}
inline fun ViewManager.toolbar(theme: Int = 0, init: (@AnkoViewDslMarker _Toolbar).() -> Unit): android.widget.Toolbar {
...
inline fun Context.toolbar(theme: Int = 0, init: (@AnkoViewDslMarker _Toolbar).() -> Unit): android.widget.Toolbar {
    return ankoView(`$$Anko$Factories$Sdk25ViewGroup`.TOOLBAR, theme) { init() }
}

inline fun Activity.toolbar(theme: Int = 0): android.widget.Toolbar = toolbar(theme) {}
inline fun Activity.toolbar(theme: Int = 0, init: (@AnkoViewDslMarker _Toolbar).() -> Unit): android.widget.Toolbar {
    return ankoView(`$$Anko$Factories$Sdk25ViewGroup`.TOOLBAR, theme) { init() }
}

inline fun ViewManager.viewAnimator(theme: Int = 0): android.widget.ViewAnimator = viewAnimator(theme) {}
inline fun ViewManager.viewAnimator(theme: Int = 0, init: (@AnkoViewDslMarker _ViewAnimator).() -> Unit): android.widget.ViewAnimator {
...
inline fun Context.viewAnimator(theme: Int = 0, init: (@AnkoViewDslMarker _ViewAnimator).() -> Unit): android.widget.ViewAnimator {
    return ankoView(`$$Anko$Factories$Sdk25ViewGroup`.VIEW_ANIMATOR, theme) { init() }
}

inline fun Activity.viewAnimator(theme: Int = 0): android.widget.ViewAnimator = viewAnimator(theme) {}
inline fun Activity.viewAnimator(theme: Int = 0, init: (@AnkoViewDslMarker _ViewAnimator).() -> Unit): android.widget.ViewAnimator {
    return ankoView(`$$Anko$Factories$Sdk25ViewGroup`.VIEW_ANIMATOR, theme) { init() }
}

inline fun ViewManager.viewSwitcher(theme: Int = 0): android.widget.ViewSwitcher = viewSwitcher(theme) {}
inline fun ViewManager.viewSwitcher(theme: Int = 0, init: (@AnkoViewDslMarker _ViewSwitcher).() -> Unit): android.widget.ViewSwitcher {
...
inline fun Context.viewSwitcher(theme: Int = 0, init: (@AnkoViewDslMarker _ViewSwitcher).() -> Unit): android.widget.ViewSwitcher {
    return ankoView(`$$Anko$Factories$Sdk25ViewGroup`.VIEW_SWITCHER, theme) { init() }
}

inline fun Activity.viewSwitcher(theme: Int = 0): android.widget.ViewSwitcher = viewSwitcher(theme) {}
inline fun Activity.viewSwitcher(theme: Int = 0, init: (@AnkoViewDslMarker _ViewSwitcher).() -> Unit): android.widget.ViewSwitcher {
    return ankoView(`$$Anko$Factories$Sdk25ViewGroup`.VIEW_SWITCHER, theme) { init() }
}
