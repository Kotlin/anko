...
fun android.media.tv.TvView.onUnhandledInputEvent(l: (event: android.view.InputEvent?) -> Boolean) {
    setOnUnhandledInputEventListener(l)
}

fun android.view.View.onApplyWindowInsets(l: (v: android.view.View?, insets: android.view.WindowInsets?) -> android.view.WindowInsets?) {
...
fun android.view.View.onContextClick(l: (v: android.view.View?) -> Boolean) {
...
fun android.view.View.onScrollChange(l: (v: android.view.View?, scrollX: Int, scrollY: Int, oldScrollX: Int, oldScrollY: Int) -> Unit) {
...
fun android.widget.ActionMenuView.onMenuItemClick(l: (item: android.view.MenuItem?) -> Boolean) {
...
fun android.widget.Toolbar.onMenuItemClick(l: (item: android.view.MenuItem?) -> Boolean) {
    setOnMenuItemClickListener(l)
}
