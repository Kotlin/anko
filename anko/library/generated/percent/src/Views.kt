...
inline fun ViewManager.percentFrameLayout(theme: Int = 0, init: (@AnkoViewDslMarker _PercentFrameLayout).() -> Unit): android.support.percent.PercentFrameLayout {
...
inline fun Context.percentFrameLayout(theme: Int = 0, init: (@AnkoViewDslMarker _PercentFrameLayout).() -> Unit): android.support.percent.PercentFrameLayout {
    return ankoView(`$$Anko$Factories$PercentViewGroup`.PERCENT_FRAME_LAYOUT, theme) { init() }
}

inline fun Activity.percentFrameLayout(theme: Int = 0): android.support.percent.PercentFrameLayout = percentFrameLayout(theme) {}
inline fun Activity.percentFrameLayout(theme: Int = 0, init: (@AnkoViewDslMarker _PercentFrameLayout).() -> Unit): android.support.percent.PercentFrameLayout {
    return ankoView(`$$Anko$Factories$PercentViewGroup`.PERCENT_FRAME_LAYOUT, theme) { init() }
}
...
inline fun ViewManager.percentRelativeLayout(theme: Int = 0, init: (@AnkoViewDslMarker _PercentRelativeLayout).() -> Unit): android.support.percent.PercentRelativeLayout {
...
inline fun Context.percentRelativeLayout(theme: Int = 0, init: (@AnkoViewDslMarker _PercentRelativeLayout).() -> Unit): android.support.percent.PercentRelativeLayout {
    return ankoView(`$$Anko$Factories$PercentViewGroup`.PERCENT_RELATIVE_LAYOUT, theme) { init() }
}
...
inline fun Activity.percentRelativeLayout(theme: Int = 0, init: (@AnkoViewDslMarker _PercentRelativeLayout).() -> Unit): android.support.percent.PercentRelativeLayout {
    return ankoView(`$$Anko$Factories$PercentViewGroup`.PERCENT_RELATIVE_LAYOUT, theme) { init() }
}
