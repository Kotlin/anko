...
public class BasicXmlTest extends Assert {
    ...
    public BasicXmlTest() {
        c.run("testdata/com/jetbrains/android/dsl/tests/xmlconverter/BasicXml.xml.in");
    }

    @Test
    public void testUI() throws Exception {
        String convertedActual = c.toString();
        String convertedExpected = loadOrCreate(new File("testdata/com/jetbrains/android/dsl/tests/xmlconverter/BasicXml.xml.out"),
                convertedActual);
    ...
    public void testResourceIds() throws Exception {
        ...
        String resourcesExpected = loadOrCreate(new File("testdata/com/jetbrains/android/dsl/tests/xmlconverter/BasicXml.res.xml.out"),
                resourcesActual);
