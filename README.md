...
The release `0.10.6` has satellite `0.10.6-eap-13` which is meant to be used with Kotlin 1.3 and release kotlinx.coroutines. Feel free to try it and provide any feedback.
